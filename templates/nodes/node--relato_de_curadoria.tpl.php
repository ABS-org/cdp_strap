...
/**
 * @file
 * Template para o tipo de conteúdo relato de curadoria
 */
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="destacado clearfix">
    <?php print render($content['field_escolher_fotografia_imagem']); ?>
    <header>
      ...
      <?php print render($content['field_resumo_do_relato']); ?>
    </header>
